...
网络接口是 Linux 提供的关于 *网络连接* 的抽象。可以粗浅的理解为网卡，而实际上不只是网卡，还包括虚拟接口（比如 [[id:074dc125-7f79-49de-b685-dd71657e7129][Docker]] 和 [[id:d580dda6-e826-4d03-be65-6743c8a364a5][VMWare]] ）回环设备等。
